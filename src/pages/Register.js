...
export const Register = () => {
  ...
  async function handleRegister(event) {
    ...
    const response = await fetch("http://localhost:8000/register", requestOptions); //this is 'post' request we are sending whole obj "authDetail"
    //console.log(response);
    //once iam send the above request i get some response
    ...
    /**Once i register then i get the access token  that means my "registration" is successfully*/
