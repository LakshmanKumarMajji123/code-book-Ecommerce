...
export const FilterBar = ({ setShow }) => {  //pass the prop obj "{setShow}"

  //Accessing "state & dispatch" form value obj in "FilterContext.js"
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="text-slate-700 dark:text-slate-100">
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">                                      {/**bestSellerOnly: !false = true or !true = false */}
...
/**
 * we insert "checked={state.onlyInStock || false}" then it show warning as
 * 
 * "bundle.js:14622 Warning: You provided a `checked` prop to a form field without an `onChange` handler. 
 * This will render a read-only field. If the field should be mutable use `defaultChecked`. 
 * Otherwise, set either `onChange` or `readOnly`."
 * 
 * so that'why we put "onChange" instead of "onClick"
 */